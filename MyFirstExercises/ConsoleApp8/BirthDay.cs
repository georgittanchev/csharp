...
class BirthDay
{
    static void Main()
    {
        Console.WriteLine("Въведете дължина, широчина, височина и процент на предварително заемане на част от аквариума, за да изчислите обема, който може да бъде напълнен с вода");
        double lenght = double.Parse(Console.ReadLine());
        double width = double.Parse(Console.ReadLine());
        double height = double.Parse(Console.ReadLine());
        double parcentage = double.Parse(Console.ReadLine());
        double obem = lenght * width * height;
        double lt = obem * 0.001;
    }
}
